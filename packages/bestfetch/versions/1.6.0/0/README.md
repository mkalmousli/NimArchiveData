...
[link to full spreadsheet](https://docs.google.com/spreadsheets/d/1mHaadB_gK3qPWw7WVu2EBXPIE8e-Pe64L3QrZB4fBjk/edit?usp=sharing)
...
![bedrock](media/distros/bedrock.png)
![cachyos](media/distros/cachyos.png)
...
![pop](media/distros/pop.png)
![ubuntu](media/distros/ubuntu.png)
![void](media/distros/void.png)

All distro ascii art was made by me. You are allowed to use them in your own projects as long as you follow the GNU GPLv3