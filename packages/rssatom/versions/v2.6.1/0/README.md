...
links and author are handled differently in Atom and RSS. links are included as an attribute in Atom and as text in RSS. Users should be mindful of this and also regarding users. To avoid more problems RSS objects that deal with RSS have an additional Author object that may have the fields *name*, *email*, *uri* for Atom, and *legacyRss* for RSS
...
rss.title = "This is a test".some()
rss.link = "link.com".some()
rss.author.legacyRss = "Samuel R.".some()
rss.description = "this is a test for this and that".some()
