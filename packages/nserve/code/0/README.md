...
| :--- | :--- | :--- |
| **Windows** | x64 | [**nserve_v1.0.4_windows_amd64.exe**](https://github.com/v4rm4n/nserve/releases/download/v1.0.4/nserve_v1.0.4_windows_amd64.exe) |
| **Linux** | x64 | [**nserve_v1.0.4_linux_amd64.elf**](https://github.com/v4rm4n/nserve/releases/download/v1.0.4/nserve_v1.0.4_linux_amd64.elf) |
...
git clone https://github.com/v4rm4n/nserve.git
cd nserve
