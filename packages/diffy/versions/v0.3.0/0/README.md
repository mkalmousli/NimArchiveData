...
- `startCenter`: If `true`, starts searching at the center of the image or bounding box searching in a spiral out fashion; if `false`, starts at top-left coordinates
